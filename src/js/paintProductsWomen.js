...
export const getProductosM = async() => {
    ...
    if(checkPrecio1.checked){
        ...
        const productosMujer = dataProductosM.filter(producto => producto.precio >= e.target.min && producto.precio <= e.target.max);
        console.log(productosMujer);
        contenidoMujer.innerHTML = "";
        productosMujer.forEach(( producto ) => {
            const contentProductM = document.createElement("div");
    ...
    talla1.addEventListener("click", e => {
        ...
        checkPrecio3.checked = false;
        console.log(e.target.value)
        const productosMujer = dataProductosM.filter(producto => producto.talla == e.target.value);
        console.log(productosMujer);
        contenidoMujer.innerHTML = "";
        productosMujer.forEach(( producto ) => {
            const contentProductM = document.createElement("div");
